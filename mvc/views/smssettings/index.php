                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="<?php if($astalking == 1) echo 'active'; ?>"><a data-toggle="tab" href="#astalking" aria-expanded="true">Africa's Talking</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="astalking" class="tab-pane <?php if($astalking == 1) echo 'active';?> ">
                                <br>
                                <div class="row">
                                    <div class="col-sm-10">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            <?php echo form_hidden('type', 'astalking'); ?>
                                            <?php
                                                if(form_error('astalking_username'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="astalking_username" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_username")?>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_astalking)): ?>
                                                    <input type="text" class="form-control" id="astalking_username" name="astalking_username" value="<?=set_value('astalking_username')?>" >
                                                  <?php else: ?>
                                                    <input type="text" class="form-control" id="astalking_username" name="astalking_username" value="<?=set_value('astalking_username', $set_astalking['astalking_username'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('astalking_username'); ?>
                                                </span>
                                            </div>

                                            <?php
                                                if(form_error('astalking_password'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="astalking_password" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_api_key")?>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_astalking)): ?>
                                                    <input type="text" class="form-control" id="astalking_password" name="astalking_password" value="<?=set_value('astalking_password')?>" >
                                                  <?php else: ?>
                                                    <input type="text" class="form-control" id="astalking_password" name="astalking_password" value="<?=set_value('astalking_password', $set_astalking['astalking_password'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('astalking_password'); ?>
                                                </span>
                                            </div>
