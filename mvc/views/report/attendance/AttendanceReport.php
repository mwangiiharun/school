<div class="box-header bg-gray">
    <h3 class="box-title text-navy"><i class="fa fa-clipboard"></i> <?=$this->lang->line('report_class')?> <?=$class->classes?> ( <?=$sectionName?> ) <?=$type?> <?=$this->lang->line('report_attendance')?> <?=$this->lang->line('panel_title')?></h3>
</div><!-- /.box-header -->
<!-- form start -->
<div class="box-body">
    <div class="row">
